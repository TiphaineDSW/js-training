[![Build Status](https://travis-ci.org/TiphaineDSW/js-training.svg?branch=master)](https://travis-ci.org/TiphaineDSW/js-training)
## Setup
First, [**fork**](https://github.com/TiphaineDSW/js-training/fork?fragment=1) this repository.
...
./tester
```
![output-tester](https://github.com/TiphaineDSW/js-training/blob/master/img/output-tester.png)
...
```
![output-node](https://github.com/TiphaineDSW/js-training/blob/master/img/output-node.png)
...
![where-to-code](https://github.com/TiphaineDSW/js-training/blob/master/img/where-to-code.png)

## Get Help !
We maintain an example based code documentation

All you need to know to solve those exercises is described in them.
- [Primitive and Operators](https://github.com/TiphaineDSW/js-training/blob/master/examples/primitive-and-operators.js) [[screencast](https://scrimba.com/c/cwyaEAd)]
- [Variables](https://github.com/TiphaineDSW/js-training/blob/master/examples/variables.js) [[screencast](https://scrimba.com/c/cLrBKA8)]
- [Data-Structures](https://github.com/TiphaineDSW/js-training/blob/master/examples/data-structures.js) [[screencast](https://scrimba.com/c/c9Py3sG)]
- [Get](https://github.com/TiphaineDSW/js-training/blob/master/examples/get.js) [[screencast](https://scrimba.com/c/cvzg2Tq)]
- [Set](https://github.com/TiphaineDSW/js-training/blob/master/examples/set.js) [[screencast](https://scrimba.com/c/cbWrGcg)]
- ...[full list](https://github.com/TiphaineDSW/js-training/tree/master/examples)
...
- make a pull request !`https://github.com/TiphaineDSW/js-training/compare/master...GITHUB_LOGIN:master`
